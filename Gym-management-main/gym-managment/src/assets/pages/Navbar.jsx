    ...
    <>
        ...
        <div className="nav-container">
          ...
          <ul className="nav-menu">
            ...
            {(user?.role === 'trainer' || user?.role === 'nutritionist') && (
              <li>
                <Link to="/specialist/dashboard" style={linkStyle} onMouseOver={(e) => e.currentTarget.style.color = 'var(--accent-primary)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-primary)'}>Specialist Hub</Link>
              </li>
            )}
      ...
      {isOpen && (
        <div className="nav-mobile-overlay">
          ...
          {(user?.role === 'trainer' || user?.role === 'nutritionist') && (
            <Link to="/specialist/dashboard" className="nav-mobile-link">Specialist Hub</Link>
          )}
